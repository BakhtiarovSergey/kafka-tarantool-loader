...
--     storage.space.EMPLOYEES_TRANSFER:insert{1,1,1,1,'Test','IT','Test',300,100}
--     storage.space.EMPLOYEES_TRANSFER:insert{2,1,1,1,'Test','IT','Test',300,100}
--     storage.space.EMPLOYEES_TRANSFER:insert{3,1,1,1,'Test','IT','Test',300,100}
...
--     local test_row3_3 =  storage.space.EMPLOYEES_TRANSFER:get{1,2}

--     t.assert_equals(err3, nil)
--     t.assert_equals(res3, true)
--     t.assert_equals(cnt3_2,5)
--     t.assert_equals(cnt3_3,1)
--     t.assert_equals(test_row3_1, {1, 1, 1, 1, 1, 'Test', 'IT', 'Test', 300, 100})
--     t.assert_equals(test_row3_2,nil)
--     t.assert_equals(test_row3_3, {1, 2, 1, 1, 'Test2', 'IT', 'Test', 300, 100})
-- end


-- g2.test_multiple_rows_transfer_data_to_historical_table = function ()
--     local storage = cluster:server('master-1-1').net_box
...
--     storage.space.EMPLOYEES_TRANSFER:insert{1,2,1,1,'Test','IT','Test',300,100}
--     storage.space.EMPLOYEES_TRANSFER:insert{2,2,1,1,'Test','IT','Test',300,100}
--     storage.space.EMPLOYEES_TRANSFER:insert{3,2,1,1,'Test','IT','Test',300,100}
...
--     t.assert_equals(res2, true)
--     t.assert_equals(cnt2_1,5)
--     t.assert_equals(cnt2_2,5)

-- end

-- g2.test_100k_rows_transfer_data_to_historical_table = function ()

--     log.error(cluster)
--     local storage = cluster:server('master-1-1').net_box
--     --local storage2 = cluster:server('storage-2').net_box


--     local function datagen(number_of_rows,version)
--         for i=1,number_of_rows,1 do
--             storage.space.EMPLOYEES_TRANSFER:insert{i,version,1,1,'Test','IT','Test',300,100}
--         end
--     end
...
g2.test_100k_rows_transfer_data_scd = function()
    ...
    local function datagen(number_of_rows)
        local tuples = {}
        for i=1,number_of_rows,1 do
            table.insert(tuples, {i,1,'123','123','123',100,0,100})
        end
        local tuples_for_insert = {
            ['EMPLOYEES_HOT'] = tuples
        }
        storage:call('insert_tuples', { tuples_for_insert })
    end

    datagen(1000000)

    require('fiber').sleep(300)
